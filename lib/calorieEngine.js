...
export function calculateCalories({
  ...
  if (weightAdj?.[normBCS]?.Calorie_Delta_Percent)
  totalAdjustment += weightAdj[normBCS].Calorie_Delta_Percent;

if (seasonalAdj?.[normSeason]?.Calorie_Adjustment_Percent)
  totalAdjustment += seasonalAdj[normSeason].Calorie_Adjustment_Percent;
